	...
	return (
		<Dialog open={open} onClose={closeModal}>
			{isLoaded ? (
				<>
					...
					<DialogContent dividers>
						<Grid container spacing={2}>
							...
							<Grid item xs={10}>
								<Typography variant="body1">
									{buyOrder?.Listado[0].Descripcion}
								</Typography>
							</Grid>
							<span style={{ height: "30px", width: "100%" }} />
							<Grid item xs={12}>
							...
							<Grid item xs={8}>
								<Typography variant="body1">
									{buyOrder?.Listado[0].Fechas.FechaCreacion}
								</Typography>
							</Grid>
							<Grid item xs={4}>
							...
							<Grid item xs={8}>
								<Typography variant="body1">
									{buyOrder?.Listado[0].Fechas.FechaEnvio}
								</Typography>
							</Grid>
							<Grid item xs={4}>
							...
							<Grid item xs={8}>
								<Typography variant="body1">
									{buyOrder?.Listado[0].Fechas.FechaAceptacion}
								</Typography>
							</Grid>
							<span style={{ height: "30px", width: "100%" }} />
							<Grid item xs={12}>
							...
							<Grid item xs={10}>
								<Typography variant="body1">
									{buyOrder?.Listado[0].Proveedor.Codigo}
								</Typography>
							</Grid>
							<Grid item xs={2}>
								<Typography variant="h6">Nombre:</Typography>
							...
							<Grid item xs={10}>
								<Typography variant="body1">
									{buyOrder?.Listado[0].Proveedor.Nombre}
								</Typography>
							</Grid>
							<Grid item xs={2}>
							...
							<Grid item xs={10}>
								<Typography variant="body1">
									{buyOrder?.Listado[0].Proveedor.Actividad}
								</Typography>
							</Grid>
							<Grid item xs={2}>
							...
							<Grid item xs={10}>
								<Typography variant="body1">
									{buyOrder?.Listado[0].Proveedor.Direccion},{" "}
									{buyOrder?.Listado[0].Proveedor.Comuna}
								</Typography>
							</Grid>
							<Grid item xs={2}>
							...
							<Grid item xs={10}>
								<Typography variant="body1">
									{buyOrder?.Listado[0].Proveedor.FonoContacto}
								</Typography>
							</Grid>
							<Grid item xs={2}>
							...
							<Grid item xs={10}>
								<Typography variant="body1">
									{buyOrder?.Listado[0].Proveedor.MailContacto}
								</Typography>
							</Grid>
							<span style={{ height: "30px", width: "100%" }} />
				...
				<Backdrop open={!isLoaded} invisible={isLoaded}>
					<Loader
						type="Puff"
