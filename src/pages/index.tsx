		...
		<Container maxWidth="sm">
			<Box my={4}>
				...
				<Typography variant="h4" align="center" gutterBottom>
					Consulta las órdenes de compra de cualquier fecha registradas en la
					base de datos de
				</Typography>
				<Typography variant="h4" align="center" gutterBottom>
					<Link
				...
				<Box style={{ textAlign: "-webkit-center" as "center" }}>
					<img
						src="images/regiones-de-chile-13.png"
						style={{ maxWidth: "100%" }}
					/>
				</Box>
				<Box
					style={{
						borderTop: "3px solid #3c5194",
						position: "relative",
						marginLeft: "calc(276px - 50vw)",
						width: "100vw",
						top: "-25px",
						zIndex: ("-1" as any) as number,
					}}
				/>
				<Box style={{ width: "100%", height: "100px" }} />
				<Copyright />
